...
cd /d "%~dp0"
set "LOG=%~dp0SUPERADMINWEB_5_22_2_LOG.txt"
>"%LOG%" echo NexoMarket Super Admin Web 5.22.2
>>"%LOG%" echo Fecha: %date% %time%
if not exist "%~dp0NexoMarket_SuperAdmin_5_22_2.hta" (
...
start "" mshta.exe "%~dp0NexoMarket_SuperAdmin_5_22_2.hta"
exit /b 0
