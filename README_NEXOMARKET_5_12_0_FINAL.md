...
- Mantiene las funciones anteriores de pedidos, cupones, reputación, destacadas y pagos de plataforma; el panel Windows se retira en 5.12.10 y la operación queda en Web + SuperAdmin.
...
## Nota
No se deben eliminar archivos funcionales del proyecto solo para reducir el tamaño. La limpieza de esta entrega elimina documentación/versiones duplicadas, pero conserva los proyectos necesarios para Central, SuperAdmin, herramientas e instalador; el panel Windows se retira en 5.12.10.
