...
namespace NexoMarket.Admin.UI
{
    ...
    public sealed class WebServerService : IDisposable
    {
        ...
        private string StoreCard(RemoteStore s, string href)
        {
            ...
            string tier = s.FeaturedPlus ? "<span class='store-tier plus'>✦ DESTACADA PLUS</span>" : (s.Featured ? "<span class='store-tier'>★ DESTACADA</span>" : "");
            string rating = "";
