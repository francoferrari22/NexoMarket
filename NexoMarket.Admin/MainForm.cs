...
namespace NexoMarket.Admin
{
    public sealed class MainForm : Form
    {
        ...
        private Control BuildSettings()
        {
            ...
            TextBox publicUrl=FieldInPanel(web,"URL pública de la tienda",_store.GetSetting("web_public_url","https://tudominio.com"),22);
            TextBox apiUrl=FieldInPanel(web,"URL de API / sincronización",_store.GetSetting("web_api_url","https://tudominio.com"),88);
