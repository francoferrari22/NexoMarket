# NexoMarket Central Server 5.12.7 ROOT ORDER FIX RENDER BUILD CLEAN - Render / Docker
...
RUN echo "=== NEXOMARKET 5.12.7 ROOT ORDER FIX RENDER BUILD CLEAN / SOURCE CHECK ===" && \
