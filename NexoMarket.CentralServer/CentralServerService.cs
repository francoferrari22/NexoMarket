...
namespace NexoMarket.CentralServer
{
    ...
    public sealed class CentralServerService : IDisposable
    {
        ...
        private string Storefront(string slug, string cookie, string query)
        {
            ...
            string realId=S(store,"StoreId");CentralUser viewer=SessionUser(cookie);string reviewOrder=QueryValue(query,"review");
...
".coupon-promo-card .price,.coupon-card .price{color:#ffd84d!important;text-shadow:0 0 12px rgba(255,216,77,.18)}" +
