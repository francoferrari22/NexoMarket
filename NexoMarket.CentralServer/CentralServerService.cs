        ...
        private string CreateOrder(Dictionary<string,string> f)
        {
            ...
            lock(_sync)
            {
                ...
                if(store==null)
                {
                    ...
                    if(storesRoot!=null) store=storesRoot.Elements("Store").FirstOrDefault(x =>
                        string.Equals(NormalizeStoreId(S(x,"StoreId")),NormalizeStoreId(rawStoreId),StringComparison.OrdinalIgnoreCase) ||
