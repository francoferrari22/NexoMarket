...
.grid .card .store-card-cover img{width:100%;height:100%;object-fit:cover;display:block;filter:saturate(.82) brightness(.48);transform:scale(1.015);transition:transform .45s ease,filter .45s ease}
.grid .card .store-card-cover:after{content:'';position:absolute;inset:0;background:linear-gradient(180deg,rgba(3,7,12,.18) 0%,rgba(3,7,12,.24) 28%,rgba(3,7,12,.80) 78%,rgba(3,7,12,.96) 100%),linear-gradient(135deg,rgba(57,255,102,.06),rgba(167,103,255,.10) 55%,rgba(54,164,255,.04));backdrop-filter:blur(1px)}
.grid .card .store-card-content{position:absolute;inset:0;z-index:2;display:flex;flex-direction:column;justify-content:flex-end;min-width:0;padding:14px 15px 15px;background:linear-gradient(180deg,transparent 20%,rgba(4,7,12,.08) 38%,rgba(4,7,12,.52) 68%,rgba(4,7,12,.90) 100%);backdrop-filter:none}
.grid .card .logo-wrap{position:absolute;top:13px;left:13px;width:68px;height:68px;margin:0;z-index:5}
.grid .card .logo-wrap .logo,.grid .card .logo-wrap .logo img{width:68px;height:68px;border-radius:17px}
.grid .card .logo-wrap .logo{display:flex;align-items:center;justify-content:center;overflow:hidden;background:rgba(8,11,16,.88);border:1px solid rgba(255,255,255,.26);box-shadow:0 0 18px rgba(0,0,0,.42),0 0 20px rgba(57,255,102,.10);backdrop-filter:blur(8px)}
.grid .card .logo-wrap .logo img{object-fit:cover;display:block}
.grid .card .logo-wrap .logo>span{font-size:28px;font-weight:950;color:#fff;text-shadow:0 0 14px rgba(57,255,102,.45)}
.grid .card .logo-star{position:absolute;right:-5px;top:-5px;width:25px;height:25px;display:flex;align-items:center;justify-content:center;border-radius:50%;background:linear-gradient(145deg,#ffd84d,#ffb300);color:#201600;font-size:13px;border:2px solid #0a0d12;box-shadow:0 0 13px rgba(255,216,77,.48);z-index:6}
.grid .card .tier-badge{align-self:flex-start;margin:0 0 6px;padding:4px 8px;border-radius:999px;font-size:8px;font-weight:950;letter-spacing:.65px;line-height:1;color:#fff;background:rgba(7,10,15,.72);border:1px solid rgba(255,255,255,.18);backdrop-filter:blur(8px)}
.grid .card .tier-badge.tier-featured{color:#7cff9a;border-color:rgba(57,255,102,.55);box-shadow:0 0 12px rgba(57,255,102,.10)}
.grid .card .tier-badge.tier-plus{color:#ead6ff;border-color:rgba(167,103,255,.72);box-shadow:0 0 14px rgba(167,103,255,.18)}
.grid .card .name{font-size:20px;line-height:1.08;margin:0 0 4px;color:#fff;text-shadow:0 2px 12px rgba(0,0,0,.65),0 0 14px rgba(167,103,255,.14);white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
.grid .card .meta{font-size:10px;line-height:1.35;color:#c3ccd5;text-shadow:0 1px 8px rgba(0,0,0,.8);white-space:nowrap;overflow:hidden;text-overflow:ellipsis;margin:1px 0}
.grid .card .open{font-size:11px;font-weight:900;color:#78ff9b;text-shadow:0 0 10px rgba(57,255,102,.20);margin-top:4px}
.grid .card .open.closed{color:#ff8399;text-shadow:0 0 10px rgba(255,59,95,.18)}
.grid .card .distance{font-size:10px;color:#d8dee5;margin-top:3px;white-space:nowrap;overflow:hidden;text-overflow:ellipsis}
...
.grid .card:hover{transform:translateY(-5px);border-color:rgba(255,255,255,.30);box-shadow:0 18px 42px rgba(0,0,0,.48),0 0 28px rgba(57,255,102,.08)}
.grid .card:hover .store-card-cover img{transform:scale(1.06);filter:saturate(.95) brightness(.58)}
.grid .card.featured{border-color:rgba(57,255,102,.24)}
.grid .card.plus{border-color:rgba(167,103,255,.40);box-shadow:0 12px 34px rgba(0,0,0,.36),0 0 26px rgba(167,103,255,.10)}
@media(max-width:950px){.grid{grid-template-columns:repeat(2,minmax(0,1fr))}.grid .card{height:300px}}
@media(max-width:650px){.wrap{padding:12px 10px 70px}.grid{grid-template-columns:1fr;gap:11px}.grid .card{height:255px;border-radius:16px}.grid .card .logo-wrap{width:62px;height:62px;top:10px;left:10px}.grid .card .logo-wrap .logo,.grid .card .logo-wrap .logo img{width:62px;height:62px;border-radius:15px}.grid .card .name{font-size:18px}.grid .card .meta{font-size:9px}.grid .card .open,.grid .card .distance,.grid .card .rating-public{font-size:10px}.grid .card .store-card-content{padding:12px}.grid .card .tier-badge{font-size:7px}}
